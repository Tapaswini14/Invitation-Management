...
@Component({
  selector: 'app-hindu-groom-wedding',
  templateUrl: './hindu-groom-wedding.component.html',
  styleUrls: ['./hindu-groom-wedding.component.css'],
})
export class HinduGroomWeddingComponent {
