...
@Component({
  selector: 'app-christian-bride-invitation',
  templateUrl: './christian-bride-invitation.component.html',
  styleUrls: ['./christian-bride-invitation.component.css'],
})
export class ChristianBrideInvitationComponent {
  selectedFile: File[] = [];
  submitted = false;
