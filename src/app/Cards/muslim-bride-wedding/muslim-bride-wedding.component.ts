...
@Component({
  selector: 'app-muslim-bride-wedding',
  templateUrl: './muslim-bride-wedding.component.html',
  styleUrls: ['./muslim-bride-wedding.component.css'],
})
export class MuslimBrideWeddingComponent {
